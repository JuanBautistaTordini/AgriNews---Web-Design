  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-green-50 to-green-100">
      ...
      <main
        ...
        style={{
          backgroundSize: "100% 35%", // Ajusta el tamaño del fondo
        }}
      >
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="relative group">
            ...
            {!isAtStart && (
              <button
                onClick={() => scroll('left')}
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-20 bg-white/90 p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
            ...
            {!isAtEnd && (
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-20 bg-white/90 p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
            ...
            >
              {courses.map((course, index) => (
                <div
                  key={index}
                  className="w-full md:w-[calc(33.333%-1rem)] lg:w-[calc(25%-1rem)] shrink-0"
                >
